...
app.post('/sync-access-request-preapproval', authorization, function(req, res) {
    // This line prints the event data received by the trigger on the command line.
    // This is meant for debugging purposes and should probably be removed once you are ready to 
    // deploy to production.
...
// date and time.
app.post('/dynamic-access-request-preapproval', authorization, function(req, res) {
    // This line prints the event data received by the trigger on the command line.
    // This is meant for debugging purposes and should probably be removed once you are ready to 
    // deploy to production.
    console.log(`/dynamic-access-request-preapproval received a body with the following contents:\n ${JSON.stringify(req.body, null, 2)}`)
